"""
datasources.content resource operations.
...
class DatasourcesContentResource:
    """datasources.content resource operations."""

    def __init__(self, http: HttpClient):
        self._http = http

    def list_datasource_content(self, datasource_id: str, prefix: Optional[Union[str, None]] = None, continuation_token: Optional[Union[str, None]] = None, limit: Optional[int] = None) -> PaginatedIterator["ContentItem"]:
        """
...
class AsyncDatasourcesContentResource:
    """datasources.content resource operations (async)."""

    def __init__(self, http: AsyncHttpClient):
        self._http = http

    async def list_datasource_content(self, datasource_id: str, prefix: Optional[Union[str, None]] = None, continuation_token: Optional[Union[str, None]] = None, limit: Optional[int] = None) -> AsyncPaginatedIterator["ContentItem"]:
        """
        List datasource content
