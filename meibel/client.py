...
from .resources.file_upload import FileUploadResource, AsyncFileUploadResource
...
class MeibelClient:
    ...
    def __init__(
        ...
        self.agents.sessions = SessionsResource(self._http)
        self.datasources.data_elements = DataElementsResource(self._http)
        self.datasources.downloads = DownloadsResource(self._http)
        self.datasources.file_upload = FileUploadResource(self._http)
        self.datasources.ingest = IngestResource(self._http)
        self.datasources.table_descriptions = TableDescriptionsResource(self._http)
...
class AsyncMeibelClient:
    ...
    def __init__(
        ...
        self.agents.sessions = AsyncSessionsResource(self._http)
        ...
        self.datasources.file_upload = AsyncFileUploadResource(self._http)
        self.datasources.ingest = AsyncIngestResource(self._http)
        self.datasources.table_descriptions = AsyncTableDescriptionsResource(self._http)
